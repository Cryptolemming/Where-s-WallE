...
var StartGame = React.createClass({displayName: "StartGame",
	onClickHandler: function(evt) {
		return this.props.onClick(this.props.newGame())
	},
	render: function() {
		return (
...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	infoCreation: function() {
		return React.createElement(StartGame, {onClick: this.onStartGame, newGame: this.newGame});
	},
	...
	render: function() {
		return React.createElement("div", {className: "game-container"}, 
				React.createElement("div", {className: "game-info"}, this.state.info
				), 
