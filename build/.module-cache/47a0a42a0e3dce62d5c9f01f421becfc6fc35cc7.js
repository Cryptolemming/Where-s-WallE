...
var Card = React.createClass({displayName: "Card",
	...
	render: function() {
		...
		return (
			React.createElement("li", {className: "game-card", onClick: this.onClickHandler, style: this.props.styling})
		);
	}
});
...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	boardCreation: function (images, flipped, styling) {
	    ...
	    return images.map(function (image, i) {
	         return React.createElement(Card, {key: i, onClick: self.onCardFlip, image: image, styling: styling[i], image: image, flipped: flipped[i], cardIndex: i});
	    });
	},
	getInitialState: function() {
	    ...
	    var styling = this.styling(flipped);
	    return {
	        imagesArray: images,
	        flipped: flipped,
	        imagesFlipped: [],
	        styling: styling,
	        board: this.boardCreation(images, flipped, styling),   
	    };
	},
