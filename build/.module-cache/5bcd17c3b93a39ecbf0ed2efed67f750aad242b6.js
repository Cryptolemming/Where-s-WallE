	...
	render: function() {
		return React.createElement("div", {className: "game-container"}, 
				React.createElement("div", {className: "game-info"}, 
					React.createElement("ul", {className: "game-data"}, 
						React.createElement("li", null, "WallEs Found: ", this.state.walleCount), 
						React.createElement("li", null, "Flips Remaining: ", this.state.wrongFlips), 
