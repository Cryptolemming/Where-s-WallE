...
var Pic = React.createClass({displayName: "Pic",
	render: function() {
		return (
			React.createElement("li", {className: "game-block game-pic", style: {background: 'url(images/walle.jpg'}})
		);
	}
});
...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	render: function() {
		...
		for (var i = 0; i < 6; i+=1) {
			...
			pics.push(React.createElement(Pic, {key: i}));
		}
		return React.createElement("ul", {className: "grid"}, pics);
	}
});
