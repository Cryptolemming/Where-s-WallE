...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	boardCreation: function(array) {
		var board = [];
		var flipped = [false, false, false, false, false, false];
		for (var i = 0; i < 6; i+=1) {
			board.push(React.createElement(Card, {key: i, image: this.state.array[i], onClick: this.onCardFlip, flipped: flipped[i], cardIndex: i}));
		}; 
		return board;
	},
	getInitialState: function() {
		var imageShuffle = this.shuffledImages(['walle.jpg', 'walle.jpg', 'eve.jpg', 'john.jpg', 'captain2.jpg', 'mary.jpg']);
		var boardCreate = this.boardCreation(imageshuffle);
		return {
