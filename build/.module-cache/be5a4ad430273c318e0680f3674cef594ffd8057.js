	...
	render: function() {
		return React.createElement("div", {className: "game-container"}, 
				React.createElement("div", {className: "game-info"}, 
					React.createElement("div", {className: "game-counters"}, 
						React.createElement("img", {className: "walle-counter", src: "images/walle.jpg"}), ":", this.state.walleCount, 
						"X: ", this.state.wrongFlips
					), 
						this.state.gameInfo
				), 
