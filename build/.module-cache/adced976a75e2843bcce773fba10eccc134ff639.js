...
React.render(React.createElement(Game, null), document.getElementById('game-board-container'));
React.render(React.createElement(Title, null), document.getElementById('title-container'));
