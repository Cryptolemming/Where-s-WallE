...
var StartGame = React.createClass({displayName: "StartGame",
	render: function() {
		return (
			React.createElement("div", null, React.createElement("button", {className: "start-button", onClick: this.props.onClick}, "Start Game"), 
			React.createElement("p", {className: "game-counters"}, "Walles: ", this.props.walles, " Flips Remaining: ", this.props.errors)
			)
		);
	}
});
...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	infoCreation: function(walles) {
		walles = walles || this.state.walleCount;
		return React.createElement(StartGame, {onClick: this.onStartClick, walles: this.state.walleCount, errors: this.state.wrongFlips});
	},
	...
	render: function() {
		return React.createElement("div", {className: "game-container"}, 
				React.createElement("div", {className: "game-info"}, React.createElement("p", null, "Flips Remaining: ", this.state.wrongFlips), this.state.gameInfo
				), 
