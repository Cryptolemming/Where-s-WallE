...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	boardCreation: function() {
		var board = [];
		for (var i = 0; i < 6; i+=1) {
			board.push(React.createElement(Card, {key: i, image: this.state.imagesArray[i], onClick: this.onCardFlip, flipped: this.flipped[i], cardIndex: i}));
		}; 
		return board;
	},
	...
	getInitialState: function() {
		return {
			...
			counter: 0,
			imagesArray: this.props.initialArray,
...
React.render(React.createElement(GameBoard, {initialArray: this.shuffledImages(['walle.jpg', 'walle.jpg', 'eve.jpg', 'john.jpg', 'captain2.jpg', 'mary.jpg'])}), document.getElementById('game-board-container'));
