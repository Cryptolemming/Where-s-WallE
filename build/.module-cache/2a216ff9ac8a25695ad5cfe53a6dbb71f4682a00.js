...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	boardCreation: function() {
		return {
			board: function() {var board = []; for (var i = 0; i < 6; i+=1) {
			board.push(React.createElement(Card, {key: i, image: this.imagesArray[i], onClick: this.onCardFlip, flipped: this.state.flipped[i], cardIndex: i}));
			}; return board},
			imagesArray: function() {return this.shuffle(['walle.jpg', 'walle.jpg', 'eve.jpg', 'john.jpg', 'captain2.jpg', 'mary.jpg'])},
	...
	getInitialState: function() {
		return {
			board: this.boardCreation.board,
			imagesArray: this.boardCreation.imagesArray,
			flipped: [false, false, false, false, false, false],
			flippedImages: [],
			walleCount: 0,
		}
