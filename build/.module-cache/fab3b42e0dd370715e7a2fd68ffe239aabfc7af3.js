...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	boardCreation: function (images, flipped) {
		var self = this;
	    images = images || self.state.images;
	    flipped = flipped || self.state.flipped;
	    
	    return images.map(function (image, i) {
	         return React.createElement(Card, {key: i, onClick: self.onCardFlip, image: image, flipped: self.flipped[i], cardIndex: i});
	    });
	},
