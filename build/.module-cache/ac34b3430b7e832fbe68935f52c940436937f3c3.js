...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	render: function() {
		...
		return React.createElement("ul", {className: "grid", onClick: this.onBlockClick, style: {background: 'url(image/' + this.state.pic + ')'}}, board, this.state.array, this.state.count);
	}
});
