...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	render: function() {
		return React.createElement("div", {className: "game-board"}, React.createElement("ul", {className: "grid"}, this.state.board), this.state.imagesFlipped, this.state.walleCount);
	}
});
