...
var StartGame = React.createClass({displayName: "StartGame",
	render: function() {
		return (
			React.createElement("button", {className: "start-button", onClick: this.props.onClick, style: this.props.styling}, "START")
		);
	}
});
...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	infoCreation: function(gameOver) {
		...
		return React.createElement(StartGame, {onClick: this.onStartClick, styling: this.gameOverStyling});
	},
