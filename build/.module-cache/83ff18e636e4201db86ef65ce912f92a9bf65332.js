...
var Card = React.createClass({displayName: "Card",
	...
	render: function() {
		...
		return (
			React.createElement("li", {className: "game-card", onClick: this.onClickHandler, style: styling, gameOver: this.props.gameOver()})
		);
	}
});
...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	boardCreation: function (images, flipped) {
	    ...
	    return images.map(function (image, i) {
	         return React.createElement(Card, {key: i, onClick: self.onCardFlip, image: image, gameOver: self.gameOver, styling: self.styling, image: image, flipped: flipped[i], cardIndex: i});
	    });
	},
