...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	render: function() {
		...
		return React.createElement("ul", {className: "grid", onClick: this.props.exposed.push('4')}, board, this.props.exposed);
	}
});

var exposed = ['sadfsdfs'];

React.render(React.createElement(GameBoard, {exposed: exposed}), document.getElementById('game-board'));
