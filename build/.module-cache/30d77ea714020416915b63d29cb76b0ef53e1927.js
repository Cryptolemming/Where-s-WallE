...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	render: function() {
		return React.createElement("div", {className: "game-container"}, 
				React.createElement("div", {className: "game-info"}, React.createElement("p", {className: "game-data"}, "WallEs Found: ", this.state.walleCount, " Flips Remaining: ", this.state.wrongFlips), this.state.gameInfo
				), 
