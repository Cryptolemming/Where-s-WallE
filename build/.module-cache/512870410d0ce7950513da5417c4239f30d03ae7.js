...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	boardCreation: function (images, flipped) {
	    ...
	    for (var i = 0; i < this.images.length; i += 1) {
	    	board.push(React.createElement(Card, {key: i, onClick: this.onCardFlip, image: this.images[i], flipped: this.flipped[i], cardIndex: i}));
	    };
	    return board;
	},
	getInitialState: function() {
	    ...
	    return {
	        ...
	        flippedImages: [],
	        walleCount: 0,
	        board: this.boardCreation(this.images, flipped),
	    };
	},
