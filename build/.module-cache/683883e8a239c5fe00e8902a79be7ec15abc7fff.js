...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	boardCreation: function (images, flipped, win) {
	    ...
	    if (win) {
	    	return React.createElement(Win, {style: winStyling, win: win});
	    }
	...
	getInitialState: function() {
	    ...
	    return {
	        ...
	        board: this.boardCreation(images, flipped, this.onStartClick),
	...
	onCardFlip: function(cardIndex) {
		...
		var updatedBoard = this.boardCreation(this.state.imagesArray, currentStateFlipped, this.state.win);
		if (walles >= 2) {
			this.setState({
				gameOver: true,
				win: true,
