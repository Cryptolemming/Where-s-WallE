...
var Card = React.createClass({displayName: "Card",
	render: function() {
		return (
			React.createElement("li", {className: "game-card", onClick: this.this.onCardFlip(this.cardIndex)})
		);
	}
});
...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	render: function() {
		...
		var board = [];
		for (var i = 0; i < 6; i+=1) {
			board.push(React.createElement(Card, {key: i, image: imagesShuffled[i], flipped: this.state.flipped[i], cardIndex: i}));
		}
