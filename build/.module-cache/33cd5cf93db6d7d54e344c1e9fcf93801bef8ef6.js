...
var StartGame = React.createClass({displayName: "StartGame",
	render: function() {
		...
		return (
			React.createElement("li", null, React.createElement("button", {className: "start-button", onClick: this.props.onClick, style: styling}, React.createElement("i", {className: "fa fa-refresh"})))
		);
	}
});
