...
var StartGame = React.createClass({displayName: "StartGame",
	render: function() {
		...
		return (
			React.createElement("li", {className: "refresh"}, React.createElement("button", {className: "start-button", onClick: this.props.onClick, style: styling}, React.createElement("i", {className: "fa fa-refresh"}, "sdfdsfs")))
		);
	}
});
