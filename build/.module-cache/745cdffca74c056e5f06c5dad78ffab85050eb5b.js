...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	render: function() {
		...
		var board = [];
		for (var i = 0; i < 6; i+=1) {
			board.push(React.createElement(Block, {key: i, pic: imagesShuffled[i], exposed: this.exposed.exposed}));
		}
		return React.createElement("ul", {className: "grid", onClick: on.handleclick}, board, this.exposed.exposed);
	}
});
