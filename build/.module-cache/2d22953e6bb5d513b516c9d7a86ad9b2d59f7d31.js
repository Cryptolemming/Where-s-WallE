...
var Block = React.createClass({displayName: "Block",
	...
	render: function() {
		...
		var randomImage = images.splice(Math.floor(Math.random() * images.length), 1);
		var styleFlipped = {
		...
		return (
			React.createElement("li", {className: "game-block", onClick: this.onBlockClick2, style: flip}, this.state)
		);
	}
});
