...
var StartGame = React.createClass({displayName: "StartGame",
	render: function() {
		return (
			React.createElement("button", {className: "start-button", onClick: this.props.onClick}, this.props.walles-1, "Start Game")
		);
	}
});
...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	infoCreation: function(walles) {
		...
		return React.createElement(StartGame, {onClick: this.onStartClick, walles: this.state.walleCount});
	},
	...
	render: function() {
		return React.createElement("div", {className: "game-container"}, 
				React.createElement("div", {className: "game-info"}, 
					this.state.walleCount, this.state.gameInfo
				), 
