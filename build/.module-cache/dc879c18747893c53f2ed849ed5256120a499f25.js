...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	infoCreation: function(walleCount) {
		walleCount = walleCount || this.state.walleCount;
		return React.createElement(StartGame, {onClick: this.onStartClick, walles: walleCount});
	},
	...
	onStartClick: function() {
	    ...
	    this.setState ({
	        ...
	        flipCount: 0,
			wrongFlips: 4,
	        gameInfo: this.infoCreation(walleCount),
	        board: this.boardCreation(images, flipped),
	    });
	},
