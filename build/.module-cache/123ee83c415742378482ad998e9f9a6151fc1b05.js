...
var GameBoard = React.createClass({displayName: "GameBoard",
	...
	onCardFlip: function(cardIndex) {
		...
		this.setState({
			...
			flippedImages: this.state.flippedImages.push(this.imagesArray[cardIndex]),
		})
	},
	...
	render: function() {
		return React.createElement("div", {className: "game-board"}, React.createElement("ul", {className: "grid"}, this.createBoard.board), this.state.flipped);
	}
});
